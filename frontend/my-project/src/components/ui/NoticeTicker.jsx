...
const NoticeTicker = () => {
  ...
  return (
    <div className="bg-[#EEEEEE] text-gray-800 py-2 overflow-hidden flex items-center">
      <div className="container mx-auto flex items-center px-4">
        <div className="flex items-center bg-[#71C9CE] px-2 md:px-3 py-1 rounded mr-2 md:mr-4 z-10 shadow-md whitespace-nowrap">
