...
const NoticeTicker = () => {
  ...
  return (
    <div className="bg-[#FF9494] text-white font-bold py-2 overflow-hidden flex items-center">
      <div className="container mx-auto flex items-center px-4">
        <div className="flex items-center bg-[#3282B8] px-2 md:px-3 py-1 rounded mr-2 md:mr-4 z-10 shadow-md whitespace-nowrap">
          ...
          <span className="font-bold text-sm hidden md:inline text-white">Notice</span>
        </div>
